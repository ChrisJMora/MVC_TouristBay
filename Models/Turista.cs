...
namespace MVC_TouristBay.Models
{
    public class Turista
    {
        ...
        [Required]
        private string _direccionTurista;
        [Required]
        ...
        public string DireccionTurista { get => _direccionTurista; set => _direccionTurista = value; }
        ...
        // Constructor
        public Turista(string nombre, string apellido, string direccion, int telefono, int sucursal, int hotel)
        {
            _idTurista = 0;
