...
namespace MVC_TouristBay.Utils
{
    public class ListaTuristas
    {
        ...
        {
            //Turistas
            Turista t1 = new Turista("Christian", "Jácome", "cj@gmail.com", 123, 0, 0, 1);
            Turista t2 = new Turista("David", "Pérez", "dp@gmail.com", 456, 0, 0, 2);
            Turista t3 = new Turista("Xavier", "Romo", "xr@gmail.com", 789, 0, 0, 3);
            Turista t4 = new Turista("Sofía", "Tamayo", "st@gmail.com", 123, 0, 0, 4);
            Turista t5 = new Turista("Pedro", "Rojas", "pr@gmail.com", 456, 0, 0, 5);
